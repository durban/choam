...
val sbtTypelevelVersion = "0.6.7" // https://github.com/typelevel/sbt-typelevel
...
addSbtPlugin("com.github.sbt" % "sbt-native-packager" % "1.9.16") // https://github.com/sbt/sbt-native-packager
