...
private[stream] sealed trait StreamSyntax0 extends StreamSyntax1 {
  implicit def asyncQueueChunkNoneTerminatedSyntax[F[_], A](q: AsyncQueue[F, Option[Chunk[A]]]): AsyncQueueChunkNoneTerminatedSyntax[F, A] =
    new AsyncQueueChunkNoneTerminatedSyntax(q)
}

private[stream] sealed trait StreamSyntax1 extends StreamSyntax2 {
  implicit def asyncQueueChunkSyntax[F[_], A](q: AsyncQueue[F, Chunk[A]]): AsyncQueueChunkSyntax[F, A] =
    new AsyncQueueChunkSyntax(q)
}

private[stream] sealed trait StreamSyntax2 extends StreamSyntax3 {
  implicit def asyncQueueNoneTerminatedSyntax[F[_], A](q: AsyncQueue[F, Option[A]]): AsyncQueueNoneTerminatedSyntax[F, A] =
    new AsyncQueueNoneTerminatedSyntax(q)
}

private[stream] sealed trait StreamSyntax3 {
  implicit def asyncQueueSyntax[F[_], A](q: AsyncQueue[F, A]): AsyncQueueSyntax[F, A] =
    new AsyncQueueSyntax(q)
}

final class AsyncQueueSyntax[F[_], A](private val self: AsyncQueue[F, A])
  extends AnyVal {
...
final class AsyncQueueChunkSyntax[F[_], A](private val self: AsyncQueue[F, Chunk[A]])
  extends AnyVal {
...
final class AsyncQueueNoneTerminatedSyntax[F[_], A](private val self: AsyncQueue[F, Option[A]])
  extends AnyVal {
...
final class AsyncQueueChunkNoneTerminatedSyntax[F[_], A](private val self: AsyncQueue[F, Option[Chunk[A]]])
  extends AnyVal {
