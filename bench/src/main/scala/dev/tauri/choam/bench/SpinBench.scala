...
class SpinBench {
  ...
  def baseline1(s: SpinSt, bh: Blackhole): Unit = {
    bh.consume(s.single.unsafePerform((), s.mcasImpl, maxBackoff = 0, randomizeBackoff = false))
  }

  @Benchmark
  @Group("withOnSpinWait1")
  def withOnSpinWait1(s: SpinSt, bh: Blackhole): Unit = {
    bh.consume(s.single.unsafePerform((), s.mcasImpl, maxBackoff = 1, randomizeBackoff = false))
  }

  @Benchmark
  @Group("withExpWait1")
  def withExpWait1(s: SpinSt, bh: Blackhole): Unit = {
    bh.consume(s.single.unsafePerform((), s.mcasImpl, maxBackoff = 16, randomizeBackoff = false))
  }

  @Benchmark
  @Group("withExpWait1Rnd")
  def withExpWait1Rnd(s: SpinSt, bh: Blackhole): Unit = {
    bh.consume(s.single.unsafePerform((), s.mcasImpl, maxBackoff = 16, randomizeBackoff = true))
  }
  ...
  def baseline2Backward(s: SpinSt, bh: Blackhole): Unit = {
    bh.consume(s.backward.unsafePerform((), s.mcasImpl, maxBackoff = 0, randomizeBackoff = false))
  }

  @Benchmark
  @Group("withOnSpinWait2")
  def withOnSpinWait2Forward(s: SpinSt, bh: Blackhole): Unit = {
    bh.consume(s.forward.unsafePerform((), s.mcasImpl, maxBackoff = 1, randomizeBackoff = false))
  }

  @Benchmark
  @Group("withOnSpinWait2")
  def withOnSpinWait2Backward(s: SpinSt, bh: Blackhole): Unit = {
    bh.consume(s.backward.unsafePerform((), s.mcasImpl, maxBackoff = 1, randomizeBackoff = false))
  }

  @Benchmark
  @Group("withExpWait2")
  def withExpWait2Forward(s: SpinSt, bh: Blackhole): Unit = {
    bh.consume(s.forward.unsafePerform((), s.mcasImpl, maxBackoff = 16, randomizeBackoff = false))
  }

  @Benchmark
  @Group("withExpWait2")
  def withExpWait2Backward(s: SpinSt, bh: Blackhole): Unit = {
    bh.consume(s.backward.unsafePerform((), s.mcasImpl, maxBackoff = 16, randomizeBackoff = false))
  }

  @Benchmark
  @Group("withExpWait2Rnd")
  def withExpWait2RndForward(s: SpinSt, bh: Blackhole): Unit = {
    bh.consume(s.forward.unsafePerform((), s.mcasImpl, maxBackoff = 16, randomizeBackoff = true))
  }
