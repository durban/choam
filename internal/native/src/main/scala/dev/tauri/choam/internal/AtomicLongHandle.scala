...
private[choam] object AtomicLongHandle extends AtomicLongHandleCompanionScalaVer {

  @alwaysinline
  final def newAtomicLongHandleDoNotCallThisMethod(ptr: Ptr[atomic_llong]): AtomicLongHandle = {
