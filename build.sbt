...
lazy val dependencies = new {
  ...
  val fs2Version = "3.13.0-M8" // https://github.com/typelevel/fs2 // TODO:0.5: don't use RC/M
  ...
  val lincheck = Def.setting("org.jetbrains.lincheck" % "lincheck" % "3.5-SNAPSHOT" changing()) // https://github.com/JetBrains/lincheck
  ...
  val test = Def.setting[Seq[ModuleID]] {
    Seq(
      ...
      "org.scalameta" %%% "munit" % "1.2.1", // https://github.com/scalameta/munit
