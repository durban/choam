...
val jvmLatest = JavaSpec.temurin("26")
...
val jvmOpenj9Latest = JavaSpec.semeru("26")
...
lazy val commonSettingsJvm = Seq[Setting[_]](
  ...
  ) ++ (if (java.lang.Runtime.version().feature() == 26) {
    // CI debugging:
    Seq("--sun-misc-unsafe-memory-access=debug")
  } else {
    Nil
  }),
  libraryDependencies ++= Seq(
...
lazy val commonSettings = Seq[Setting[_]](
  ...
  // disable build server protocol for JS/SN (idea from
...
lazy val dependencies = new {
  ...
  val catsEffectVersion = "3.7.1" // https://github.com/typelevel/cats-effect
  val catsCollectionsVersion = "0.9.10" // https://github.com/typelevel/cats-collections
  val fs2Version = "3.14.0" // https://github.com/typelevel/fs2
  val scalacheckEffectVersion = "2.1.0" // https://github.com/typelevel/scalacheck-effect
  ...
  val zioVersion = "2.1.26" // https://github.com/zio/zio
  ...
  val jcTools = Def.setting("org.jctools" % "jctools-core" % "4.0.7") // https://github.com/JCTools/JCTools
  ...
  val zioCats = Def.setting("dev.zio" %%% "zio-interop-cats" % "23.1.0.13")
  ...
  val test = Def.setting[Seq[ModuleID]] {
    Seq(
      ...
      "org.scalameta" %%% "munit" % "1.3.6", // https://github.com/scalameta/munit
      "org.typelevel" %%% "munit-cats-effect" % "2.2.0", // https://github.com/typelevel/munit-cats-effect
      "org.scalacheck" %%% "scalacheck" % "1.20.0", // https://github.com/typelevel/scalacheck
