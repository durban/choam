...
final class CountDownLatchSpec_SpinLockMcas_IO_Real
  extends BaseSpecIO
  with SpecSpinLockMcas
  with CountDownLatchSpec[IO]

final class CountDownLatchSpec_SpinLockMcas_IO_Ticked
...
final class CountDownLatchSpec_Emcas_IO_Ticked
  extends BaseSpecTickedIO
  with SpecEmcas
  with CountDownLatchSpecTicked[IO]
