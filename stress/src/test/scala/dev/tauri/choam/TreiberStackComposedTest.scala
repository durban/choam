...
@KCASParams("Treiber stack composed pop/push should be atomic")
@Outcomes(Array(
...
abstract class TreiberStackComposedTest(impl: KCAS) {
  ...
  def pop(r: LLL_Result): Unit = {
    r.r1 = tryPop.unsafeRun
  }

  @Arbiter
  def arbiter(r: LLL_Result): Unit = {
    r.r2 = stack1.unsafeToList
    r.r3 = stack2.unsafeToList
  }
}
